...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      authService.signup(formData.name, formData.email, formData.password, formData.confirmPassword);
        ...
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-300">
              Join TicketFlow and start managing tickets efficiently
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 py-8 px-6 shadow-xl rounded-2xl">
            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary dark:focus:ring-indigo-400 focus:border-transparent transition bg-white dark:bg-gray-700 text-gray-900 dark:text-white dark:placeholder-gray-400 ${errors.name ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'}`}
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Confirm Password</label>
                <input
                  id="confirmPassword"
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary dark:focus:ring-indigo-400 focus:border-transparent transition bg-white dark:bg-gray-700 text-gray-900 dark:text-white dark:placeholder-gray-400 ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'}`}
                  placeholder="••••••••"
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600 dark:text-gray-300">
                ...
                <Link to="/auth/login" className="text-primary dark:text-indigo-400 hover:text-primary-light dark:hover:text-indigo-300 font-semibold focus:outline-none focus:underline">
                  Sign in
                </Link>
              </p>
            </div>
